================================================================================
    MICROSOFT FOUNDATION CLASS LIBRARY : opencvmfc Project Overview
===============================================================================

The application wizard has created this opencvmfc application for
...
opencvmfcDlg.h, opencvmfcDlg.cpp - the dialog
    ...
    in opencvmfc.rc, which can be edited in Microsoft Visual C++.
